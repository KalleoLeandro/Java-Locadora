...
/**
 * Classe responsável por armazenar as telas e componentes do processo de consulta de vendedores
...
{//inicio da classe		
	...
	private String colunas [] = {"Nome", "Área de Vendas", "Cidade", "Estado", "Sexo", "Idade","Salario"};
